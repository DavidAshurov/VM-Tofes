    ...
    return (
        <>
            <div className={'flex justify-center pt-8'}>
                <h1 className={'text-3xl font-bold mr-20'}>{Hebrew.blankHeader}</h1>
            </div>
            <div className={'flex justify-around font-bold'}>
                ...
                <div className={'flex justify-around items-center w-[55%] underline'}>
                    <div className={'text-2xl'}>{shiftInfo.shift === 'morning' ? Hebrew.blankMorning : Hebrew.blankEvening}</div>
                    <div className={'text-2xl'}>{`${today.toLocaleDateString()} ${Hebrew.blankDate}`}</div>
                </div>
            </div>
        </>
